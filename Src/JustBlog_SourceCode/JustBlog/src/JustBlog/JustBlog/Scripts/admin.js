$(function () {
  ...
  ObjectRef.GridManager = {};

  //************************* POSTS GRID
  ObjectRef.GridManager.postsGrid = function (gridName, pagerName) {
    ...
    var addOptions = {
      ...
      onClose: onClose,
      afterSubmit: ObjectRef.GridManager.afterSubmitHandler,
  ...
  //************************* CATEGORIES GRID
  ObjectRef.GridManager.categoriesGrid = function (gridName, pagerName) {
  ...
  //************************* TAGS GRID
  ObjectRef.GridManager.tagsGrid = function (gridName, pagerName) {
    var colNames = ['Id', 'Name', 'Url Slug', 'Description'];
  ...
  ObjectRef.GridManager.afterSubmitHandler = function (response, postdata) {
  ...
  $("#tabs").tabs({
    show: function (event, ui) {
      ...
      if (!ui.tab.isLoaded) {
        ...
        var gdMgr = ObjectRef.GridManager,
