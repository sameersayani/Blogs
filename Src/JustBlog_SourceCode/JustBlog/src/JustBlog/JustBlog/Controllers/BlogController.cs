...
using ObjectRef.Core;
using ObjectRef.Core.Objects;
using ObjectRef.Models;
#endregion

namespace ObjectRef.Controllers
{
  /// <summary>
    ...
    public ViewResult Contact(Contact contact)
    {
      if (ModelState.IsValid)
      {
        using (var client = new SmtpClient())
        {
          ...
          var from = new MailAddress(adminEmail, "ObjectRef Messenger");
          var to = new MailAddress(adminEmail, "ObjectRef Admin");
